        ...
        <div className={TrainingCSS["Container"]}>
            ...
            <div className={TrainingCSS["Services"]}>
                <div className={TrainingCSS["Skills"]}>
                    ...
                    <div className={TrainingCSS["Image"]}>
                    <img src="/Images/11.png" alt="" className={TrainingCSS["IMG"]}/>
                    </div>
                </div>
                <div className={TrainingCSS["Skills"]}>
                <div className={TrainingCSS["Text"]}>
                ...
                <div className={TrainingCSS["Image"]}>
                    <img src="/Images/10.png" alt="" className={TrainingCSS["IMG"]}/>
                </div>
                </div>
                <div className={TrainingCSS["Skills"]}>
                <div className={TrainingCSS["Text"]}>
                ...
                <div className={TrainingCSS["Image"]}>
                <img src="/Images/12.png" alt="" className={TrainingCSS["IMG"]}/>
                </div>
                </div>
            </div>
        </div>
